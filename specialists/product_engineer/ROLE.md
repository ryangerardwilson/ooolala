...
component boundaries. The backend keeps Elixir's supervision and concurrency
model, and the web app remains React/Vite/Tailwind. Do not migrate backend or
web solely to match the terminal client.
...
- Keep terminal-specific formatting in the terminal client.
