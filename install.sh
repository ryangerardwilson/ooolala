...
DEFAULT_WEB_URL="${OOOLALA_DEFAULT_WEB_URL:-https://ooolala.ryangerardwilson.com}"
...
INSTALL_URL="${OOOLALA_INSTALL_URL:-${DEFAULT_WEB_URL%/}/install.sh}"
...
export OOOLALA_WEB_URL="\${OOOLALA_WEB_URL:-$DEFAULT_WEB_URL}"
